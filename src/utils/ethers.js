...
export const contracts = {
  sd: {
    token: new Contract(
      contractAddrs.sd.jewel,
      contractJson.jewel.abi,
      RPCs.sd
    ),
    xToken: new Contract(
      contractAddrs.sd.xJewel,
      contractJson.xJewel.abi,
      RPCs.sd
    ),
    gardener: new Contract(
      contractAddrs.sd.gardener,
      contractJson.gardener.abi,
      RPCs.sd
    ),
    profile: new Contract(
      contractAddrs.sd.profile,
      contractJson.profile.abi,
      RPCs.sd
    ),
  },
  cv: {
    token: new Contract(
      contractAddrs.cv.crystal,
      contractJson.crystal.abi,
      RPCs.cv
    ),
    xToken: new Contract(
      contractAddrs.cv.xCrystal,
      contractJson.xCrystal.abi,
      RPCs.cv
    ),
    gardener: new Contract(
      contractAddrs.cv.gardener,
      contractJson.gardenerV2.abi,
      RPCs.cv
    ),
    profile: new Contract(
      contractAddrs.cv.profile,
      contractJson.profile.abi,
      RPCs.cv
    ),
  },
